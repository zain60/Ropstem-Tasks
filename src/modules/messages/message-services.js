import { MSG } from './message-model.js';
...
class APIfeatures {
    ...
    const getMessages =  async (req, res) => {
        try {
            const features = new APIfeatures(MSG.find({
                $or: [
...
export {createMessage,getConversations,getMessages,deleteMessages,deleteConversation};
